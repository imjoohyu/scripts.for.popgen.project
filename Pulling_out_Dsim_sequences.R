...
int.genes.cg = read.table("../list.of.case.and.cont.genes.in.Dmel.FBgn.and.CG.txt", header = T) #I changed 'NA's to right names.
...
for (i in 1:dim(int.genes.cg)[1]){
    ...
    gene.of.interest = as.character(paste(int.genes.cg[i,3],"-",sep="")); #print(gene.of.interest)
