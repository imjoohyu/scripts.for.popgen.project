...
#Randomly select 149 Dmel sequences V2 (python)
#Nov 11th, 2017
#Joo Hyun Im (ji72)

#read-in command from UNIX:
#python randomly_select_Dmel_149.py [file]
...
#2. Randomly pick 149 Dmel sequences and the top Dsim sequence (6/20/2017, 10:55am)
...
#Randomly choose 149 Dmel positions and add the Dsim outgroup position to the list
seq_num_rand = random.sample(seq_num, 149)
...
#3. Save the data
output_address = '/workdir/ji72/DH/Dmel_prepped_for_DH_Nov_2017/Dmel_' + gene_id + '_149_selected.fa'
